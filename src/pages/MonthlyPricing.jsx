        ...
        <Layout className="">
            <div className="bg-cover bg-center h-100 w-100 " style={{ backgroundImage: `url(${backgroundImage})` }}>
                ...
                <section className='flex flex-col gap-10 items-center justify-center mt-12'>
                    ...
                    <Link to="/MonthlyPricing" className="bg-[#1B72FC] rounded-lg  w-1/2  h-full outline-none text-center  cursor-pointer  text-[#ffffff] relative left-2"><input type="submit" className="h-full cursor-pointer" value="Monthly" /> </Link>
                 <Link to="/YearlyPricing" className="bg-[#DAEBFF] rounded-lg  w-1/2  h-full outline-none cursor-pointer text-center text-[#1B72FC] border-[#1B72FC]"><input type="submit" className="h-full cursor-pointer" value="Yearly" /> </Link>  
                    </div>
