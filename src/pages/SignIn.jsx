                    ...
                    <div className=" mt-40  bg-cover bg-center h-100 w-100" style={{ backgroundImage: `url(${backgroundImage})` }}>
                        ...
                        <div className="flex flex-col gap-10 justify-center items-center ">
                            <div className="flex gap-0 justify-center items-center w-[50%]  rounded-lg  h-[3rem] max-[1174px]:w-1/2 max-[768px]:w-[70%] max-[500px]:w-[80%] max-[400px]:w-[95%]">
                                <Link to="/SignUp" className="rounded-lg bg-[#DAEBFF] w-1/2  h-full outline-none text-center  cursor-pointer text-[#1B72FC] "><input type="submit" className=" h-full cursor-pointer " value="Get Started" /> </Link>
                                <Link to="/SignIn" className="bg-[#1B72FC] rounded-lg  w-1/2  h-full outline-none cursor-pointer text-center text-[#ffffff]  border-[#1B72FC]  relative right-2"><input type="submit" className="h-full cursor-pointer" value="Sign In" /> </Link>
                            </div>
